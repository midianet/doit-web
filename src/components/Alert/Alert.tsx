import { MessageType, Message }  from "../../contexts"
...
const Alert = ({ message }: AlertProps) => {
  console.log(message)
  if(message.level === MessageType.Success) {
    return (
      ...
      <svg className="flex-shrink-0 w-10 h-10" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
